...
sketchybar --add item $IMAGE_ID center \
		   ...
		   --set $IMAGE_ID background.drawing=on background.image="$HOME/.config/imgs/gundam_small.jpg" background.image.drawing=on background.image.padding_left=2 background.image.padding_right=2\
